<img width="1481" height="393" alt="ascii-art-text (4)" src="https://github.com/user-attachments/assets/f4d2ef98-1767-495d-9769-eaa476147572" />
...
![Zurb Foundation](https://img.shields.io/badge/Zurb_Foundation-1779BA?style=flat-square&logo=foundryvtt&logoColor=white)
![PHP](https://img.shields.io/badge/PHP-777BB4?style=flat-square&logo=php&logoColor=white)
![Laravel](https://img.shields.io/badge/Laravel-FF2D20?style=flat-square&logo=laravel&logoColor=white)
![MySQL](https://img.shields.io/badge/MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white)
![LAMP Stack](https://img.shields.io/badge/LAMP_Stack-FCC624?style=flat-square&logo=linux&logoColor=black)
...
- Designed UI Pages for a hotel PMS built for non-technical users.
- Led C25 UI redesign, modernized interface by 90%.
- Built and maintained front-end in HTML, CSS, and JS
- Extended the back-end with PHP + SQL.
- Produced Figma files for landing page redesign concepts.
- Audited CSS via Firefox Browser DevTools, cut load times by 55%.
- Maintained 100% CSAT rate.
- Designed digital marketing assets.
- Smoke tested new releases and flagged issues pre-deployment.
- Helped manage branches, merge requests, merge conflicts etc. (Git, GitHub, GitLab)
